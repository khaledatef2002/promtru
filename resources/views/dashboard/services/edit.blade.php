            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="gap-2 mb-3 flex-fill">
                        ...
                        <input id="description.ar" type="text" class="form-control" name="ar[description]" value="{{ $service->getTranslation('ar')->description }}">
                    </div>
                    <div class="gap-2 mb-3 flex-fill">
                        <label for="description.en">@lang('dashboard.en.description')</label>
                        <input id="description.en" type="text" class="form-control" name="en[description]" value="{{ $service->getTranslation('en')->description }}">
                    </div>
                </div>
            </div>
        </div>
