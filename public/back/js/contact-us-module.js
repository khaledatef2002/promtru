...
class ContactUsManager {
    ...
    async show(id)
    {
        ...
        if(response.success) {
            document.querySelector("#contactMessage .company").innerHTML = response.data.contact_us.company
            document.querySelector("#contactMessage .name").innerHTML = response.data.contact_us.name
